import{FishingEngine}from'./core/fishing-engine.js?v=0230';
import{LivePlusConnection,eventUser,giftMeta}from'./integrations/liveplus.js?v=0230';
import{HUD}from'./ui/hud.js?v=0230';
import{FishingScene}from'./ui/scene.js?v=0230';
import{SessionControls}from'./ui/session-controls.js?v=0230';
...
function statePayload(){return{...engine.snapshot(),paused,pendingCommands:pendingCommands.length,session:{connected:live.connected,code:live.code||''},version:'0.2.3'}}
